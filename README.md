    ...
    The color shift isn't just cosmetic — it's a constant ambient signal about what mode you're in. Easy is blue, Normal is purple, Hard shifts warmer. Once you've played a few rounds, you feel the color before you consciously read the difficulty label. I also wanted the UI to reflect the stakes. A red-orange tint on Hard makes everything feel slightly more urgent without adding any explicit UI pressure. It's a small thing, but small things accumulate. The alternative — keeping the UI the same across difficulties — would've made the modes feel like the same game with different numbers, not different experiences.
    ...
    - **Difficulty selector** — Easy (45s), Normal (30s), Hard (20s)
    ...
    - **Nebula shield** — Every 3-combo freezes the timer briefly
    ...
    - **Animated logo** — Float animation on the intro screen
